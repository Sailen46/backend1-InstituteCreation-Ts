...
class instituteAdminController {
    static createInstitute = async (req: Request, res: Response) => {
        ...
        await sequelize.query(`CREATE TABLE IF NOT EXISTS institute_${instituteNumber} (
            ...
            await sequelize.query(`INSERT INTO institute_${instituteNumber}(instituteName, instituteEmail, institutePhoneNumber, instituteAddress,institutePanNumber, instituteVatNumber) VALUES (?,?,?,?,?,?)`, {
...
export const { createInstitute } = instituteAdminController